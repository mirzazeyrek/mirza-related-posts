...
if (!class_exists('mirza_related_posts')) {
    class mirza_related_posts
    {
        ...
        public function __construct()
        {
            ...
            // inject jquery
            add_action('wp_enqueue_scripts', [&$this, 'enqueue_related_posts_jquery']);
            ...
            add_action('the_content', [&$this, 'create_related_posts_link'], 10);
        }
        ...
        {
            wp_enqueue_script('related-posts-jquery', plugins_url('/mirza-related-posts.js', __FILE__), ['jquery']);
        ...
        public function get_related_posts($post_id = null, $order_by = 'DESC', $limit = 3)
        {
